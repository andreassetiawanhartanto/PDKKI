					...
					<th>
						...
						<div id="div_enable_div" style="display:block;">
							<table>
								<tr>
									<td>
										<label class="hasTip" title="<?php echo JText::_( 'NN_WIDTH' ).'::'.JText::_( 'MA_WIDTH_DESC' ); ?>">
									...
									<td>
										<label class="hasTip" title="<?php echo JText::_( 'NN_HEIGHT' ).'::'.JText::_( 'MA_HEIGHT_DESC' ); ?>">
				...
				for ( $i=0, $n=count( $rows ); $i < $n; $i++ ) {
					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td style="text-align:center;">
							<img src="<?php echo JURI::root( true ).'/plugins/system/nnframework/images/'.$img; ?>" width="16" height="16" border="0" alt="<?php echo $alt; ?>'" />
						</td>
						<td align="center">
