...
{ 
	...
	{ 
		...
		{ 
				...
				500 : 'The file browser is disabled for one of the following reasons: 1. The user does not have sufficient privileges to access the file browser. 2.  The file browser files do not have sufficient privileges to be executable. 3 This could be due to a security rule been applied by your htaccess file.', 
