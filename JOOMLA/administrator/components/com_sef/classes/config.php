...
class SEFConfig
{
     ...
     * @var int
     */
    var $metadata_auto = _COM_SEF_META_GEN_EMPTY;    
	...
	var $google_exclude_ip="";
	// Exclude this level from Google tracking
	var $google_exclude_level=array();
    ...
    function SEFConfig ()
    {
        ...
        if (isset($professionalMode))
            $this->professionalMode = $professionalMode;
        if (isset($showInfoTexts))
        ...
        if(isset($redirectSlash)) {
        	$this->redirectSlash=$redirectSlash;	
        }
        ...
        if (isset($metadata_auto))
            $this->metadata_auto = $metadata_auto;
        if (isset($metadata_priority))
            $this->metadata_priority = $metadata_priority;
        ...
        if (isset($autolock_urls))
        	$this->autolock_urls = $autolock_urls;
        ...
        if(isset($google_password)) {
        	$this->google_password=$google_password;
        }
        if(isset($google_id)) {
        	$this->google_id=$google_id;
        }
        if(isset($google_apikey)) {
        	$this->google_apikey=$google_apikey;
        }
        if(isset($google_enable)) {
        	$this->google_enable=$google_enable;
        }
        if(isset($google_exclude_ip)) {
        	$this->google_exclude_ip=$google_exclude_ip;
        }
        if(isset($google_exclude_level)) {
        	$this->google_exclude_level=$google_exclude_level;
        }
        
        // Cron configuration
        if (isset($cronEnabled)) {
            $this->cronEnabled = $cronEnabled;
        }
        if (isset($cronOnlyLocal)) {
            $this->cronOnlyLocal = $cronOnlyLocal;
        }
        if (isset($cronKey)) {
